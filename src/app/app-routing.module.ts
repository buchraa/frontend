...
const routes: Routes = [
  ...
  { path: 'view-module/:id', canActivate:[ConnectedGuard], component:ViewModuleComponent},
  { path: 'view-oeuvre/:id', canActivate:[ConnectedGuard], component:ViewOeuvreComponent},
  { path: 'view-traduction/:id', canActivate:[ConnectedGuard], component:ViewTraductionComponent},
